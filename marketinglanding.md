# Wrapshot - Marketing Landing Page Features

> Last updated: February 2026

Use this document to keep the marketing landing page in sync with the latest product features.
...
**Tagline Options:**
- "The all-in-one film production platform powered by AI"
- "From script to screen, intelligently managed"
- "Production management that thinks ahead"

**Value Proposition:**
Wrapshot combines traditional film production tools with intelligent automation to help indie filmmakers and production teams plan, schedule, and execute their projects efficiently.
...
### Pro
- Unlimited projects
- Full AI-powered script analysis
...
- Hours saved on script breakdown
...
**Primary CTA:** "Start Your Production Free"
**Secondary CTA:** "See How It Works" (demo video)
**Tertiary CTA:** "Talk to Sales" (for Studio tier)
...
| AI Script Analysis | Limited | Full | Full |
| Team Members | 3 | Unlimited | Unlimited |
| Scene Breakdown | Basic | Full | Full |
...
- Real-time collaboration (Supabase Realtime + Liveblocks)
- Secure cloud storage for scripts and documents
...
*This document should be updated whenever new features are released or existing features are significantly enhanced.*
