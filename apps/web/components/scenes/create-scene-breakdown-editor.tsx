...
const BREAKDOWN_CATEGORIES: {
  ...
  { category: "SFX", label: "Special Effects", icon: <Lightbulb className="h-4 w-4" />, color: "bg-orange-500/10 text-orange-700 border-orange-200", column: "left" },
  // Right column
  ...
  { category: "VFX", label: "Visual Effects", icon: <Lightbulb className="h-4 w-4" />, color: "bg-purple-500/10 text-purple-700 border-purple-200", column: "right" },
