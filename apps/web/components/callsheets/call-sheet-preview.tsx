    ...
    <div className="bg-white dark:bg-zinc-950 border border-border rounded-lg print:border-none print:rounded-none">
      <div className="max-w-4xl mx-auto p-8 space-y-6 text-sm print:p-4">
        ...
        <div
          ...
          style={{ borderBottomColor: headerAccentColor, color: headerTextColor }}
        >
          {callSheet.brandLogoUrl && (
            <div className="mb-2 flex justify-center">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={callSheet.brandLogoUrl}
                alt="Call sheet logo"
                className="h-14 w-auto max-w-[220px] object-contain"
              />
            </div>
          )}
          {(callSheet.brandDisplayName || project?.productionCompany) && (
            <p className="text-xs uppercase tracking-widest mb-1" style={{ color: headerAccentColor }}>
              {callSheet.brandDisplayName || project?.productionCompany}
            </p>
          )}
            ...
            <table className="w-full border-collapse">
              ...
              <tfoot>
                <tr className="bg-muted/30 print:bg-gray-50 font-semibold">
                  ...
                  <td className="border border-border px-2 py-1.5">{formatPageEighths(totalPageEighths)}</td>
        ...
        {/* Footer */}
        <div className="border-t-2 pt-3 text-center text-xs text-muted-foreground print:mt-8" style={{ borderTopColor: headerAccentColor }}>
          <p>
            {footerLabel}
