...
> = {
  ...
  extracting_elements: { description: 'Identifying production elements', weight: 20 },
  linking_cast: { description: 'Linking characters to cast members', weight: 12 },
  generating_synopses: { description: 'Completing scene synopsis and character fields', weight: 18 },
...
> = {
  ...
  generating_synopses: { label: 'Completing Scene Fields', color: 'blue', icon: 'edit' },
